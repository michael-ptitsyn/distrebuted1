...
public class Constants {
    ...
    public static String instanceId = EC2MetadataUtils.getInstanceId()!=null?EC2MetadataUtils.getInstanceId():UUID.randomUUID().toString();
    ...
    public static final ImmutableList<String> REQUIRED = ImmutableList.of(MAC_FIELD,ID_FIELD,TYPE_FIELD);
